...
const EmailEditor = ({
  ...
  const customText = Text.extend({
    addKeyboardShortcuts() {
      return {
        "Meta-j": () => {
          void aiGenerate(this.editor.getText());
          return true;
        },
      };
    },
      ...
      <div ref={ref} className="space-y-2 p-4 pb-0">
        ...
        {isGenerating ? (
          <div className="text-sm">
            <span className="aiemail-generating-text" data-text="Generating">
              <span className="aiemail-generating__dots text-gray-900 dark:text-white">
                Generating
              </span>
            </span>
          </div>

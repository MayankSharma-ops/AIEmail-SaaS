    ...
    return (
        <>
            ...
            <div className="min-h-screen flex flex-col items-center pt-56 relative z-[10]">
                <Image src="/logo.png" alt="Mailor Logo" width={80} height={80} className="mb-6 rounded-full shadow-lg" />
                ...
                <p className="text-xl mb-8 text-gray-600 max-w-xl text-center">
                    Mailor is a minimalistic, AI-powered email client that empowers you to manage your email with ease.
                </p>
